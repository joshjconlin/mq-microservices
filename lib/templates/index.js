...
module.exports.createIndexJs = (directory, queueBase, stage) => {
  const template = `const { Bridge } = require('mq-microservices');
...
module.exports.createEnv = (directory, mqUrl, serviceHost, servicePort) => {
...
module.exports.updateServerlessYml = (directory, serviceHost, servicePort, dontMoveHandler = false) => {
...
module.exports.addDockerFile = (directory, serviceStage) => {
  const template = `FROM node:13.6.0
